...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let image = UIImage(named: "new-york-472392_1920")
        
        
        let alertController = UIAlertController(title: "Pace University Tour", message: "Welcome to Pace University \n to start Click on the blue button while hovering a building to know its name", preferredStyle: .alert)
